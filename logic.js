(() => {
  ...
  const bubbleImage = decodeURIComponent(params.get("bubbleImage") || "https://nikashum93.github.io/pusyriki/assets/bubble.png");
  const feedbackText = decodeURIComponent(params.get("feedback") || "🎉 Well done!");
  const feedbackImage = decodeURIComponent(params.get("feedbackImage") || "");
  const tasksRaw = decodeURIComponent(params.get("tasks") || "");
  ...
  const popSoundUrl = decodeURIComponent(params.get("popSound") || "https://nikashum93.github.io/pusyriki/assets/pop.mp3");
  const openSoundUrl = decodeURIComponent(params.get("openSound") || "https://nikashum93.github.io/pusyriki/assets/open.mp3");
